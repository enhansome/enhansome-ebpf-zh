...
> 注意：eBPF 是一项令人兴奋的技术，其生态系统正在快速发展。我们非常欢迎您的帮助，以保持这个列表的时效性，并以任何可能的方式提高其信噪比。请随时在[这里](https://github.com/zoidbergwill/awesome-ebpf/issues) ⭐ 5,155 | 🐛 13 | 📅 2026-08-12留下您的反馈。
...
* [内核版本中的 BPF 特性列表](https://github.com/iovisor/bcc/blob/master/docs/kernel-versions.md) ⭐ 22,650 | 🐛 1,073 | 🌐 C | 📅 2026-08-27
...
* [BPF 参考指南](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,650 | 🐛 1,073 | 🌐 C | 📅 2026-08-27 - 来自 bcc 仓库的 BPF C 和 bcc Python 辅助函数指南。
...
* [bcc 参考指南](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,650 | 🐛 1,073 | 🌐 C | 📅 2026-08-27 - 许多增量步骤来开始使用 bcc 和 eBPF，大多集中在跟踪和监视上。
* [bcc Python 开发者教程](https://github.com/iovisor/bcc/blob/master/docs/tutorial_bcc_python_developer.md) ⭐ 22,650 | 🐛 1,073 | 🌐 C | 📅 2026-08-27 - 随 bcc 一起提供，但针对 Python 代码，共包含十七个“课程”。
* [XDP 实践教程](https://github.com/xdp-project/xdp-tutorial) ⭐ 2,964 | 🐛 170 | 🌐 C | 📅 2026-05-08 - 渐进式（包含三个难度级别）的教程，学习如何使用 XDP 处理数据包。
...
* [bcc/examples](https://github.com/iovisor/bcc/tree/master/examples) ⭐ 22,650 | 🐛 1,073 | 🌐 C | 📅 2026-08-27 - 与 bcc 工具一起提供的示例，主要与跟踪有关。
* [bcc/tools](https://github.com/iovisor/bcc/tree/master/tools) ⭐ 22,650 | 🐛 1,073 | 🌐 C | 📅 2026-08-27 - 这些工具本身可以被视为 BPF 程序的示例用例，主要用于追踪和监视。 bcc 工具已针对一些 Linux 发行版进行了打包。
...
* [bcc](https://github.com/iovisor/bcc/) ⭐ 22,650 | 🐛 1,073 | 🌐 C | 📅 2026-08-27 - 框架和工具 - 一种处理 BPF 程序的方法，特别是用于跟踪和监控。还包括一些实用程序，可帮助检查系统中的映射或程序。
* [bcc 的 Lua 前端](https://github.com/iovisor/bcc/tree/master/src/lua) ⭐ 22,650 | 🐛 1,073 | 🌐 C | 📅 2026-08-27 - 另一种替代 C，甚至是 bcc 中大多数 Python 代码的选择。
...
* [libbpf](https://git.kernel.org/pub/scm/linux/kernel/git/davem/net-next.git/tree/tools/lib/bpf) - 一个用于处理BPF对象（程序和映射）和操作包含它们的ELF对象文件的C库。它随内核一起提供，并在[GitHub上进行了镜像](https://github.com/libbpf/libbpf) ⭐ 2,753 | 🐛 35 | 🌐 C | 📅 2026-07-30。
* [libbpf-bootstrap](https://github.com/libbpf/libbpf-bootstrap) ⭐ 1,520 | 🐛 18 | 🌐 CMake | 📅 2026-08-31 - 用于使用libbpf和BPF CO-RE进行BPF应用开发的脚手架。

### Go 库

* [cilium/ebpf](https://github.com/cilium/ebpf) ⭐ 7,938 | 🐛 24 | 🌐 Go | 📅 2026-09-01 - 纯Go库，用于读取、修改、加载eBPF程序并将其附加到Linux内核中的各种钩子。
...
* [aya](https://github.com/aya-rs/aya) ⭐ 4,789 | 🐛 210 | 🌐 Rust | 📅 2026-09-02 - 一种用纯 Rust 编写、加载和管理 eBPF 对象的库，专注于开发人员体验和可操作性。它支持在 Rust 中编写 eBPF 程序，并通过 crates.io 分发库代码以在 eBPF 程序之间共享。Aya 不依赖于 libbpf。
...
* [eBPF for Windows](https://github.com/microsoft/ebpf-for-windows) ⭐ 3,553 | 🐛 328 | 🌐 C | 📅 2026-08-31 - 这个项目还在进行中，它允许使用现有的eBPF工具链和Linux生态系统中熟悉的API在Windows上使用。
...
* [Cilium](https://cilium.io/) 项目 ([GitHub 代码库](https://github.com/cilium/cilium) ⭐ 25,045 | 🐛 1,088 | 🌐 Go | 📅 2026-09-02) 是一项依赖于 BPF 和 XDP 技术的项目，可为基于容器的快速内核网络和安全策略实施提供“即时生成的eBPF程序”的支持。有许多演示文稿可用（有些内容重复）：
...
* [P4 on the Edge](https://schd.ws/hosted_files/2016p4workshop/1d/Intel%20Fastabend-P4%20on%20the%20Edge.pdf) - 使用 eBPF 创建高性能可编程交换机的 P4。
  * [P4 使用 eBPF 的旧文档](https://github.com/iovisor/bcc/tree/master/src/cc/frontends/p4) ⭐ 22,650 | 🐛 1,073 | 🌐 C | 📅 2026-08-27 - 来自 bcc 存储库；由下面链接的 P4\_16 后端弃用。
  * [eBPF 的 P4\_16 后端](https://github.com/p4lang/p4c/blob/master/backends/ebpf/README.md) ⭐ 836 | 🐛 471 | 🌐 C++ | 📅 2026-09-02。
...
* [pixie](https://github.com/pixie-io/pixie) ⭐ 6,529 | 🐛 395 | 🌐 C++ | 📅 2026-07-30 - 使用eBPF进行Kubernetes的可观测性分析。支持协议跟踪，应用程序分析以及分布式bpftrace部署等功能。
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,320 | 🐛 44 | 🌐 Makefile | 📅 2026-09-01 - 使用eBPF为Kubernetes提供网络、服务和安全可观测性。
...
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 4,980 | 🐛 270 | 🌐 C | 📅 2026-09-02 - 面向 Kubernetes、基于 eBPF 的安全监测和运行时强制执行工具。
* [Tracee](https://github.com/aquasecurity/tracee) ⭐ 4,599 | 🐛 124 | 🌐 Go | 📅 2026-09-02 - 一款用于 Linux 的运行时安全和取证工具，它使用 eBPF 技术对系统和应用程序进行跟踪，在运行时分析收集的事件以检测可疑的行为模式。
* [Sysmon for Linux](https://github.com/Sysinternals/SysmonForLinux) ⭐ 2,154 | 🐛 42 | 🌐 C | 📅 2026-07-13 - 一款安全监控工具。它依赖于[SysinternalsEBPF](https://github.com/Sysinternals/SysinternalsEBPF) ⭐ 289 | 🐛 16 | 🌐 C | 📅 2026-05-07。
...
* [inspektor-gadget](https://github.com/inspektor-gadget/inspektor-gadget) ⭐ 2,915 | 🐛 434 | 🌐 C | 📅 2026-09-02 - 基于 eBPF 的工具集合，用于调试和检查 Kubernetes 资源和应用程序。
...
* [ebpfkit](https://github.com/Gui774ume/ebpfkit) ⭐ 855 | 🐛 4 | 🌐 C | 📅 2023-02-28 - 利用多种eBPF特性实施攻击性安全技术的rootkit。
...
* [IO Visor 的 bcc 文档](https://github.com/iovisor/bcc/tree/master/docs) ⭐ 22,650 | 🐛 1,073 | 🌐 C | 📅 2026-08-27
