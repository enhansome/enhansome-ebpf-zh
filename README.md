...
> 注意：eBPF 是一项令人兴奋的技术，其生态系统正在快速发展。我们非常欢迎您的帮助，以保持这个列表的时效性，并以任何可能的方式提高其信噪比。请随时在[这里](https://github.com/zoidbergwill/awesome-ebpf/issues) ⭐ 5,167 | 🐛 14 | 📅 2026-09-14留下您的反馈。
...
* [内核版本中的 BPF 特性列表](https://github.com/iovisor/bcc/blob/master/docs/kernel-versions.md) ⭐ 22,660 | 🐛 1,078 | 🌐 C | 📅 2026-09-11
...
* [BPF 参考指南](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,660 | 🐛 1,078 | 🌐 C | 📅 2026-09-11 - 来自 bcc 仓库的 BPF C 和 bcc Python 辅助函数指南。
...
* [bcc 参考指南](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,660 | 🐛 1,078 | 🌐 C | 📅 2026-09-11 - 许多增量步骤来开始使用 bcc 和 eBPF，大多集中在跟踪和监视上。
* [bcc Python 开发者教程](https://github.com/iovisor/bcc/blob/master/docs/tutorial_bcc_python_developer.md) ⭐ 22,660 | 🐛 1,078 | 🌐 C | 📅 2026-09-11 - 随 bcc 一起提供，但针对 Python 代码，共包含十七个“课程”。
* [XDP 实践教程](https://github.com/xdp-project/xdp-tutorial) ⭐ 2,973 | 🐛 170 | 🌐 C | 📅 2026-05-08 - 渐进式（包含三个难度级别）的教程，学习如何使用 XDP 处理数据包。
...
* [bcc/examples](https://github.com/iovisor/bcc/tree/master/examples) ⭐ 22,660 | 🐛 1,078 | 🌐 C | 📅 2026-09-11 - 与 bcc 工具一起提供的示例，主要与跟踪有关。
* [bcc/tools](https://github.com/iovisor/bcc/tree/master/tools) ⭐ 22,660 | 🐛 1,078 | 🌐 C | 📅 2026-09-11 - 这些工具本身可以被视为 BPF 程序的示例用例，主要用于追踪和监视。 bcc 工具已针对一些 Linux 发行版进行了打包。
...
* [bcc](https://github.com/iovisor/bcc/) ⭐ 22,660 | 🐛 1,078 | 🌐 C | 📅 2026-09-11 - 框架和工具 - 一种处理 BPF 程序的方法，特别是用于跟踪和监控。还包括一些实用程序，可帮助检查系统中的映射或程序。
* [bcc 的 Lua 前端](https://github.com/iovisor/bcc/tree/master/src/lua) ⭐ 22,660 | 🐛 1,078 | 🌐 C | 📅 2026-09-11 - 另一种替代 C，甚至是 bcc 中大多数 Python 代码的选择。
...
* [libbpf](https://git.kernel.org/pub/scm/linux/kernel/git/davem/net-next.git/tree/tools/lib/bpf) - 一个用于处理BPF对象（程序和映射）和操作包含它们的ELF对象文件的C库。它随内核一起提供，并在[GitHub上进行了镜像](https://github.com/libbpf/libbpf) ⭐ 2,754 | 🐛 32 | 🌐 C | 📅 2026-09-15。
* [libbpf-bootstrap](https://github.com/libbpf/libbpf-bootstrap) ⭐ 1,524 | 🐛 18 | 🌐 CMake | 📅 2026-09-08 - 用于使用libbpf和BPF CO-RE进行BPF应用开发的脚手架。

### Go 库

* [cilium/ebpf](https://github.com/cilium/ebpf) ⭐ 7,962 | 🐛 25 | 🌐 Go | 📅 2026-09-17 - 纯Go库，用于读取、修改、加载eBPF程序并将其附加到Linux内核中的各种钩子。
* [gobpf](https://github.com/iovisor/gobpf) ⭐ 2,179 | 🐛 82 | 🌐 C | 📅 2023-08-31 - 用于创建eBPF程序的BCC的Go绑定。
* [libbpfgo](https://github.com/aquasecurity/libbpfgo) ⭐ 850 | 🐛 35 | 🌐 Go | 📅 2026-09-15 - 由libbpf支持的用于Go的eBPF库。

### Aya

* [aya](https://github.com/aya-rs/aya) ⭐ 4,810 | 🐛 201 | 🌐 Rust | 📅 2026-09-17 - 一种用纯 Rust 编写、加载和管理 eBPF 对象的库，专注于开发人员体验和可操作性。它支持在 Rust 中编写 eBPF 程序，并通过 crates.io 分发库代码以在 eBPF 程序之间共享。Aya 不依赖于 libbpf。
* [aya-template](https://github.com/aya-rs/aya-template) ⭐ 141 | 🐛 6 | 🌐 Rust | 📅 2026-09-15 - 用于在 Aya 中编写 BPF 应用程序的模板，可以与 [`cargo generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,487 | 🐛 28 | 🌐 Rust | 📅 2026-09-15 一起使用。

### zbpf

* [zbpf](https://github.com/tw4452852/zbpf) ⭐ 277 | 🐛 5 | 🌐 Zig | 📅 2026-04-19 - 一个用纯 Zig 编写的跨平台 eBPF 程序框架，由 libbpf 和 Zig 工具链提供支持。

### eunomia-bpf

* [eunomia-bpf](https://github.com/eunomia-bpf/eunomia-bpf) ⭐ 901 | 🐛 15 | 🌐 Rust | 📅 2026-08-09 - 一个编译框架和运行库，可用于构建、分发、动态加载和运行多语言和WebAssembly的CO-RE eBPF应用程序。它支持仅写eBPF内核代码（以构建简单的CO-RE libbpf eBPF应用程序）、同时以BCC和libbpf风格编写内核部分，以及在WASM模块中以多种语言编写用户空间，并使用简单的JSON数据或WASM OCI镜像分发它。运行时仅基于libbpf，并提供CO-RE给BCC-style的eBPF程序，而不依赖于LLVM库。
...
* [rbpf](https://github.com/qmonnet/rbpf) ⭐ 1,128 | 🐛 19 | 🌐 Rust | 📅 2026-06-03 - 用 Rust 编写。用于 Linux、macOS 和 Windows 的解释器，以及在 Linux 下用于 x86\_64 的 JIT 编译器。
* [uBPF](https://github.com/iovisor/ubpf/) ⭐ 988 | 🐛 18 | 🌐 C | 📅 2026-08-08 - 用 C 编写。包含一个解释器、一个用于 x86\_64 架构的 JIT 编译器、一个汇编器和反汇编器。
* [PREVAIL](https://github.com/vbpf/ebpf-verifier) ⭐ 472 | 🐛 37 | 🌐 C++ | 📅 2026-09-13 - 用于 eBPF 的用户空间验证器，[使用抽象解释层实现](https://elazarg.github.io/pldi19main-final.pdf)，支持循环。
...
* [eBPF for Windows](https://github.com/microsoft/ebpf-for-windows) ⭐ 3,563 | 🐛 330 | 🌐 C | 📅 2026-09-17 - 这个项目还在进行中，它允许使用现有的eBPF工具链和Linux生态系统中熟悉的API在Windows上使用。
...
* [Cilium](https://cilium.io/) 项目 ([GitHub 代码库](https://github.com/cilium/cilium) ⭐ 25,238 | 🐛 1,089 | 🌐 Go | 📅 2026-09-17) 是一项依赖于 BPF 和 XDP 技术的项目，可为基于容器的快速内核网络和安全策略实施提供“即时生成的eBPF程序”的支持。有许多演示文稿可用（有些内容重复）：
...
* [P4 on the Edge](https://schd.ws/hosted_files/2016p4workshop/1d/Intel%20Fastabend-P4%20on%20the%20Edge.pdf) - 使用 eBPF 创建高性能可编程交换机的 P4。
  * [P4 使用 eBPF 的旧文档](https://github.com/iovisor/bcc/tree/master/src/cc/frontends/p4) ⭐ 22,660 | 🐛 1,078 | 🌐 C | 📅 2026-09-11 - 来自 bcc 存储库；由下面链接的 P4\_16 后端弃用。
  * [eBPF 的 P4\_16 后端](https://github.com/p4lang/p4c/blob/master/backends/ebpf/README.md) ⭐ 837 | 🐛 475 | 🌐 C++ | 📅 2026-09-17。
...
* [pixie](https://github.com/pixie-io/pixie) ⭐ 6,537 | 🐛 396 | 🌐 C++ | 📅 2026-07-30 - 使用eBPF进行Kubernetes的可观测性分析。支持协议跟踪，应用程序分析以及分布式bpftrace部署等功能。
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,332 | 🐛 44 | 🌐 Makefile | 📅 2026-09-15 - 使用eBPF为Kubernetes提供网络、服务和安全可观测性。
...
* [parca-agent](https://github.com/parca-dev/parca-agent) ⭐ 746 | 🐛 179 | 🌐 Go | 📅 2026-09-17 - 基于eBPF的持续分析CPU和内存使用情况的分析器，可分析到代码行和时间流逝情况。
...
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 5,009 | 🐛 280 | 🌐 C | 📅 2026-09-17 - 面向 Kubernetes、基于 eBPF 的安全监测和运行时强制执行工具。
* [Tracee](https://github.com/aquasecurity/tracee) ⭐ 4,618 | 🐛 119 | 🌐 Go | 📅 2026-09-15 - 一款用于 Linux 的运行时安全和取证工具，它使用 eBPF 技术对系统和应用程序进行跟踪，在运行时分析收集的事件以检测可疑的行为模式。
...
* [inspektor-gadget](https://github.com/inspektor-gadget/inspektor-gadget) ⭐ 2,926 | 🐛 424 | 🌐 C | 📅 2026-09-17 - 基于 eBPF 的工具集合，用于调试和检查 Kubernetes 资源和应用程序。
* [kubectl trace](https://github.com/iovisor/kubectl-trace) ⭐ 2,187 | 🐛 49 | 🌐 Go | 📅 2026-04-16 - 一个用于在 Kubernetes 集群中执行 bpftrace 程序的 kubectl 插件。
...
* [TripleCross](https://github.com/h3xduck/TripleCross) ⭐ 1,979 | 🐛 19 | 🌐 C | 📅 2024-04-07 - 一个Linux eBPF rootkit，具有后门、C2、库注入、执行劫持、持久性和隐蔽性能力。
* [ebpfkit](https://github.com/Gui774ume/ebpfkit) ⭐ 860 | 🐛 4 | 🌐 C | 📅 2023-02-28 - 利用多种eBPF特性实施攻击性安全技术的rootkit。
* [Bad BPF](https://github.com/pathtofile/bad-bpf) ⭐ 698 | 🐛 2 | 🌐 C | 📅 2024-07-07 - 恶意eBPF程序的集合，利用eBPF在用户模式程序和内核之间读写用户数据的能力。
* [ebpfkit-monitor](https://github.com/Gui774ume/ebpfkit-monitor) ⭐ 144 | 🐛 2 | 🌐 C | 📅 2023-02-28 - 一个实用程序，可在运行时静态分析eBPF字节码或监视可疑的eBPF活动。它专为检测ebpfkit而设计。
...
* [IO Visor 的 bcc 文档](https://github.com/iovisor/bcc/tree/master/docs) ⭐ 22,660 | 🐛 1,078 | 🌐 C | 📅 2026-09-11
