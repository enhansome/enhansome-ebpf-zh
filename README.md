...
> 注意：eBPF 是一项令人兴奋的技术，其生态系统正在快速发展。我们非常欢迎您的帮助，以保持这个列表的时效性，并以任何可能的方式提高其信噪比。请随时在[这里](https://github.com/zoidbergwill/awesome-ebpf/issues) ⭐ 5,144 | 🐛 12 | 📅 2026-08-12留下您的反馈。
...
* [内核版本中的 BPF 特性列表](https://github.com/iovisor/bcc/blob/master/docs/kernel-versions.md) ⭐ 22,626 | 🐛 1,069 | 🌐 C | 📅 2026-08-14
...
* [BPF 参考指南](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,626 | 🐛 1,069 | 🌐 C | 📅 2026-08-14 - 来自 bcc 仓库的 BPF C 和 bcc Python 辅助函数指南。
...
* [bcc 参考指南](https://github.com/iovisor/bcc/blob/master/docs/reference_guide.md) ⭐ 22,626 | 🐛 1,069 | 🌐 C | 📅 2026-08-14 - 许多增量步骤来开始使用 bcc 和 eBPF，大多集中在跟踪和监视上。
* [bcc Python 开发者教程](https://github.com/iovisor/bcc/blob/master/docs/tutorial_bcc_python_developer.md) ⭐ 22,626 | 🐛 1,069 | 🌐 C | 📅 2026-08-14 - 随 bcc 一起提供，但针对 Python 代码，共包含十七个“课程”。
...
* [bcc/examples](https://github.com/iovisor/bcc/tree/master/examples) ⭐ 22,626 | 🐛 1,069 | 🌐 C | 📅 2026-08-14 - 与 bcc 工具一起提供的示例，主要与跟踪有关。
* [bcc/tools](https://github.com/iovisor/bcc/tree/master/tools) ⭐ 22,626 | 🐛 1,069 | 🌐 C | 📅 2026-08-14 - 这些工具本身可以被视为 BPF 程序的示例用例，主要用于追踪和监视。 bcc 工具已针对一些 Linux 发行版进行了打包。
...
* [bcc](https://github.com/iovisor/bcc/) ⭐ 22,626 | 🐛 1,069 | 🌐 C | 📅 2026-08-14 - 框架和工具 - 一种处理 BPF 程序的方法，特别是用于跟踪和监控。还包括一些实用程序，可帮助检查系统中的映射或程序。
* [bcc 的 Lua 前端](https://github.com/iovisor/bcc/tree/master/src/lua) ⭐ 22,626 | 🐛 1,069 | 🌐 C | 📅 2026-08-14 - 另一种替代 C，甚至是 bcc 中大多数 Python 代码的选择。
...
* [libbpf](https://git.kernel.org/pub/scm/linux/kernel/git/davem/net-next.git/tree/tools/lib/bpf) - 一个用于处理BPF对象（程序和映射）和操作包含它们的ELF对象文件的C库。它随内核一起提供，并在[GitHub上进行了镜像](https://github.com/libbpf/libbpf) ⭐ 2,747 | 🐛 35 | 🌐 C | 📅 2026-07-30。
* [libbpf-bootstrap](https://github.com/libbpf/libbpf-bootstrap) ⭐ 1,519 | 🐛 18 | 🌐 CMake | 📅 2026-08-03 - 用于使用libbpf和BPF CO-RE进行BPF应用开发的脚手架。

### Go 库

* [cilium/ebpf](https://github.com/cilium/ebpf) ⭐ 7,916 | 🐛 21 | 🌐 Go | 📅 2026-08-18 - 纯Go库，用于读取、修改、加载eBPF程序并将其附加到Linux内核中的各种钩子。
...
* [aya](https://github.com/aya-rs/aya) ⭐ 4,770 | 🐛 204 | 🌐 Rust | 📅 2026-08-19 - 一种用纯 Rust 编写、加载和管理 eBPF 对象的库，专注于开发人员体验和可操作性。它支持在 Rust 中编写 eBPF 程序，并通过 crates.io 分发库代码以在 eBPF 程序之间共享。Aya 不依赖于 libbpf。
* [aya-template](https://github.com/aya-rs/aya-template) ⭐ 140 | 🐛 5 | 🌐 Rust | 📅 2026-08-15 - 用于在 Aya 中编写 BPF 应用程序的模板，可以与 [`cargo generate`](https://github.com/cargo-generate/cargo-generate) ⭐ 2,473 | 🐛 54 | 🌐 Rust | 📅 2026-08-17 一起使用。
...
* [eBPF for Windows](https://github.com/microsoft/ebpf-for-windows) ⭐ 3,544 | 🐛 330 | 🌐 C | 📅 2026-08-19 - 这个项目还在进行中，它允许使用现有的eBPF工具链和Linux生态系统中熟悉的API在Windows上使用。
...
* [Cilium](https://cilium.io/) 项目 ([GitHub 代码库](https://github.com/cilium/cilium) ⭐ 24,969 | 🐛 1,092 | 🌐 Go | 📅 2026-08-19) 是一项依赖于 BPF 和 XDP 技术的项目，可为基于容器的快速内核网络和安全策略实施提供“即时生成的eBPF程序”的支持。有许多演示文稿可用（有些内容重复）：
...
* [P4 on the Edge](https://schd.ws/hosted_files/2016p4workshop/1d/Intel%20Fastabend-P4%20on%20the%20Edge.pdf) - 使用 eBPF 创建高性能可编程交换机的 P4。
  * [P4 使用 eBPF 的旧文档](https://github.com/iovisor/bcc/tree/master/src/cc/frontends/p4) ⭐ 22,626 | 🐛 1,069 | 🌐 C | 📅 2026-08-14 - 来自 bcc 存储库；由下面链接的 P4\_16 后端弃用。
  * [eBPF 的 P4\_16 后端](https://github.com/p4lang/p4c/blob/master/backends/ebpf/README.md) ⭐ 835 | 🐛 472 | 🌐 C++ | 📅 2026-08-19。
...
* [Hubble](https://github.com/cilium/hubble) ⭐ 4,299 | 🐛 44 | 🌐 Makefile | 📅 2026-08-18 - 使用eBPF为Kubernetes提供网络、服务和安全可观测性。
...
* [parca-agent](https://github.com/parca-dev/parca-agent) ⭐ 742 | 🐛 180 | 🌐 Go | 📅 2026-08-17 - 基于eBPF的持续分析CPU和内存使用情况的分析器，可分析到代码行和时间流逝情况。
...
* [Tetragon](https://github.com/cilium/tetragon) ⭐ 4,933 | 🐛 252 | 🌐 C | 📅 2026-08-19 - 面向 Kubernetes、基于 eBPF 的安全监测和运行时强制执行工具。
* [Tracee](https://github.com/aquasecurity/tracee) ⭐ 4,585 | 🐛 123 | 🌐 Go | 📅 2026-08-11 - 一款用于 Linux 的运行时安全和取证工具，它使用 eBPF 技术对系统和应用程序进行跟踪，在运行时分析收集的事件以检测可疑的行为模式。
* [Sysmon for Linux](https://github.com/Sysinternals/SysmonForLinux) ⭐ 2,152 | 🐛 41 | 🌐 C | 📅 2026-07-13 - 一款安全监控工具。它依赖于[SysinternalsEBPF](https://github.com/Sysinternals/SysinternalsEBPF) ⭐ 287 | 🐛 15 | 🌐 C | 📅 2026-05-07。
...
* [inspektor-gadget](https://github.com/inspektor-gadget/inspektor-gadget) ⭐ 2,912 | 🐛 424 | 🌐 C | 📅 2026-08-19 - 基于 eBPF 的工具集合，用于调试和检查 Kubernetes 资源和应用程序。
...
* [IO Visor 的 bcc 文档](https://github.com/iovisor/bcc/tree/master/docs) ⭐ 22,626 | 🐛 1,069 | 🌐 C | 📅 2026-08-14
